...
QMAKE    = /usr/bin/qmake
RuntimeTest.xcodeproj/project.pbxproj: test.pro  /usr/local/Qt4.8/mkspecs/macx-xcode/qmake.conf /usr/local/Qt4.8/mkspecs/common/unix.conf \
		...
		/usr/local/Qt4.8/mkspecs/features/testcase.prf \
	...
	$(QMAKE) -o RuntimeTest.xcodeproj/project.pbxproj test.pro
